...
body
{
	...
	background-image:url(./image_red/line_back.gif);
...
h1{
	...
	font-family: verdana, arial, helvetica, Sans-Serif;
	background-image:url(./image_red/h2back.jpg);
	background-position:bottom left;
	background-repeat: repeat;
	border-left:8px solid #D5BABA;
	border-top:1px solid #D5BABA;
	border-bottom:1px solid #D5BABA;
	border-right:1px solid #D5BABA;
	color :#000000;
	padding: .3em;
	font-size:15px;
}
h3{
	...
	font-size:15px;
	background-image:url(./image_red/h3border.jpg);
	background-position:bottom left;
...
h4{
	...
	color: #000000;
	font-size:15px;
	background-image:url(./image_red/h4icon.gif);
...
h5, h6{
	...
	border-top:double 0px #D5BABA;
	text-align:center;
	background-image:url(./image_red/h5under.gif);
...
div#attach
{
	...
	margin:0px;
	border-bottom:5px solid #D5BABA;
}
...
.body{	background-color:#ffffff;
	color:#444444;
	padding:20px;
	border:solid 1px #D5BABA;
	}
.body a:link{color:#996633;text-decoration:none;}
.body a:hover{color:black;text-decoration:underline;}
.body a:active{color:black;text-decoration:underline;}
.body a:visited{color:#996633;text-decoration:none;}

ul li{
	list-style-image: url('./image_red/lists.gif');
}