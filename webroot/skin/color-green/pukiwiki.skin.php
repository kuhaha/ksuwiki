...
if (! defined('SKIN_DEFAULT_DISABLE_TOPICPATH'))
	define('SKIN_DEFAULT_DISABLE_TOPICPATH', $mark); // 1, 0
...
if (! defined('PKWK_SKIN_SHOW_NAVBAR'))
	define('PKWK_SKIN_SHOW_NAVBAR', $mark); // [1], 0

// ページ最下部のツールバーを表示します
// 注意：この設定は表示の切り替えだけで機能を無効にするわけではありません

if (! defined('PKWK_SKIN_SHOW_TOOLBAR'))
	define('PKWK_SKIN_SHOW_TOOLBAR', $mark); // [1], 0
unset($mark);
// ----
...
<?php if (PKWK_ALLOW_JAVASCRIPT && isset($javascript)) { ?> <meta http-equiv="Content-Script-Type" content="text/javascript" /><?php } ?>
 ...
 <link rel="stylesheet" href="<?php echo SKIN_DIR;?>color-green/pukiwiki.css.php?charset=<?php echo $css_charset ?>" type="text/css" media="screen" charset="<?php echo $css_charset ?>" />
 <link rel="stylesheet" href="<?php echo SKIN_DIR;?>color-green/pukiwiki.css.php?charset=<?php echo $css_charset ?>&amp;media=print" type="text/css" media="print" charset="<?php echo $css_charset ?>" />
...
<?php  if (isset($vars['site'])){ ?> 
  [
  <?php _navigator('site_edit') ?>
 | <?php _navigator('site_pass')   ?>
 ]
 <?php } ?> 
...
$_IMAGE['skin']['site_pass']      = 'site_pass.png';
$_IMAGE['skin']['site_edit']      = 'site_edit.png';
...
<?php } ?>
 ...
 <?php  if (isset($vars['site'])){ ?> 
 <?php _toolbar('site_edit') ?>
 <?php _toolbar('site_pass') ?>
 <?php } ?>
