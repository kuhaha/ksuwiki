...
body
{
	...
	background-image:url(./image_blue/line_back.gif);
...
h1{
	...
	font-family: verdana, arial, helvetica, Sans-Serif;
	background-image:url(./image_blue/h2back.jpg);
	background-position:bottom left;
	background-repeat: repeat;
	border-left:8px solid #BACDD5;
	border-top:1px solid #BACDD5;
	border-bottom:1px solid #BACDD5;
	border-right:1px solid #BACDD5;
	color :#000000;
	padding: .3em;
	font-size:15px;
}
h3{
	...
	font-size:15px;
	background-image:url(./image_blue/h3border.jpg);
	background-position:bottom left;
...
h4{
	...
	color: #000000;
	font-size:15px;
	background-image:url(./image_blue/h4icon.gif);
...
h5, h6{
	...
	border-top:double 0px #BACDD5;
	text-align:center;
	background-image:url(./image_blue/h5under.gif);
...
div#attach
{
	...
	margin:0px;
	border-bottom:5px solid #BACDD5;
}
...
ul li{
	list-style-image: url('./image_blue/lists.gif');
}