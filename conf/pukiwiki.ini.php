...
// by setting PKWK_HOME at index.php.



////
// Moved to site related folders in /lib/pukiwiki.php

//define('DATA_DIR',      PKWK_HOME . 'wiki/'     ); // Latest wiki texts
//define('DIFF_DIR',      PKWK_HOME . 'diff/'     ); // Latest diffs
//define('BACKUP_DIR',    PKWK_HOME . 'backup/'   ); // Backups
//define('CACHE_DIR',     PKWK_HOME . 'cache/'    ); // Some sort of caches
//define('UPLOAD_DIR',    PKWK_HOME . 'attach/'   ); // Attached files and logs
//define('COUNTER_DIR',   PKWK_HOME . 'counter/'  ); // Counter plugin's counts
//define('TRACKBACK_DIR', PKWK_HOME . 'trackback/'); // TrackBack logs
define('PLUGIN_DIR',    PKWK_HOME . 'plugin/'   ); // Plugin directory


/////////////////////////////////////////////////
// Directory settings II (ended with '/')
define('WEBROOT_DIR', PKWK_HOME . 'webroot/');

// Skins / Stylesheets
define('SKIN_DIR', WEBROOT_DIR . 'skin/');
// Skin files (SKIN_DIR/*.skin.php) are needed at ./DATAHOME/SKIN_DIR from index.php, but
// CSSs(*.css) and JavaScripts(*.js) are needed at ./SKIN_DIR from index.php.

// Static image files
define('IMAGE_DIR', WEBROOT_DIR . 'image/');
